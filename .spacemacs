...
you should place your code here."
  ...
  (defvar cyanide-project-directories '()
    "Directories where CyanIDE will attempt to autodiscover projects.")

  (add-to-list 'cyanide-project-directories "~/projects")
...
"
                     ...
                     (destination
                      (file-name-as-directory
                       (helm-read-file-name
                        ...
                        :initial-input
                        (concat
                         (file-name-as-directory (car cyanide-project-directories))
                         project-short-name))))
              ...
              (let* ((dirpath
                      (file-name-as-directory
                       (helm-read-file-name
                        ...
                        :initial-input
                        (file-name-as-directory
                         (car cyanide-project-directories)))))
  ...
  (when (eq dotspacemacs-editing-style 'emacs)
    (global-set-key (kbd "C-s-n") 'up-list)
    (global-set-key (kbd "C-s-p") 'down-list))
  ...
  (defun terminal ()
    (call-process-shell-command "nohup terminator >> /dev/null &"))

  (setq org-main-dir "~/projects/org/")

  (setq org-root (concat org-main-dir "root.org"))
  ...
  (defun vim-cheat-sheet ()
    (interactive)
    (find-file vim-cheat-sheet))

  (global-set-key (kbd "C-h O") 'org)
  ...
  (defun remove-emacs-bindings ()
    (progn
      ...
      (global-set-key (kbd "C-x r i") nil)
      (global-set-key (kbd "C-x r x") nil)
  ...
  (condition-case nil
      (load-file (concat user-home-directory ".org-templates"))
    (error nil))
  )
